...
<fieldset>
	...
	<?php echo $this->Form->create('moduloVI', array(
		...
		<div class="row">
          ...
          echo $this->Form->input('detenido_por',array('label'=>array('class'=>'control-label col-sm-6'), 'required'=>true));
          echo $this->Form->input('antecedentes_penales',array('label'=>array('class'=>'control-label col-sm-6'), 'required'=>true));
          echo $this->Form->input('tipo_delito_anterior',array('label'=>array('class'=>'control-label col-sm-6'), 'required'=>true));
          echo $this->Form->input('situacion_denunciado',array('label'=>array('class'=>'control-label col-sm-6'), 'required'=>true));
          echo $this->Form->input('situacion_victima',array('label'=>array('class'=>'control-label col-sm-6'),'options'=> $reincidencias,'empty' => 'Seleccionar', 'required'=>true));
    		?>
          </div>
          <div class="col-sm-6, col-md-5">
